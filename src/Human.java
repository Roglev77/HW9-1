...
public class Human {
    ...
    public void describePet() {
        String intelligence = (this.pet.getTrickLevel() > 50) ? "дуже хитрий" : "майже не хитрий";
        System.out.println("У мене є " + this.pet.getSpecies() + ", йому " + this.pet.getAge() + " років, він " + intelligence);
    }
